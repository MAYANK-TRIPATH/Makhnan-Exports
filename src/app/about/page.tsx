  ...
  return (
    ...
    {/* What We do */}
      <div>
        ...
        <p className="text-lg leading-relaxed w-[75%] mx-auto mt-8">
        ✅ <b>Sourcing:</b> We procure high-grade Makhana from trusted farmers and suppliers, ensuring quality at every step.<br/>
        ✅ <b>Quality Assurance:</b> While we don't process Makhana ourselves, we ensure that the product we trade meets strict quality and hygiene standards.
        <br/>
        ✅ <b>Packaging & Logistics:</b> We work with professional packaging and logistics partners to ensure safe and timely delivery across domestic and international markets.
        <br/>
